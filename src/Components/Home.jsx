...
export const WEATHER = 'b372d4144fc8b063a66a9cc94f53c34d';
...
export default function Home() {
  ...
  const geoURL = `https://www.googleapis.com/geolocation/v1/geolocate?key=AIzaSyB02p9LCXDp64Y6PhixFJmEuI-zzUKCa0E`;

  const size = '500x400';
  const zoom = 10;
  const staticURL = `https://maps.googleapis.com/maps/api/staticmap?center=${lat},${lon}&zoom=${zoom}&size=${size}&key=AIzaSyB02p9LCXDp64Y6PhixFJmEuI-zzUKCa0E${import.meta.env.VITE_MAP_API_KEY}`;
